    ...
    <section ref={containerRef} className="w-full min-h-[120vh] relative overflow-hidden bg-light pointer-events-auto flex flex-col items-center">
      ...
      >
        ...
        <div className="w-full flex flex-col items-center justify-center relative z-10">
          ...
          {/* Massive Typography */}
          <motion.div style={{ y: titleY }} className="relative flex flex-col items-center -space-y-6 md:-space-y-12 z-10 select-none w-full">
        ...
        >
          ...
          {techLabels.map((tech, i) => (
            <motion.div
              ...
              className="absolute text-3xl md:text-5xl font-bold text-gray-200 pointer-events-none whitespace-nowrap z-0"
              style={{
                top: `${20 + (i * 15)}%`,
                left: `${10 + (i * 10)}%`,
